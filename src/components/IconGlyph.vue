...
const icons: Record<string, string[]> = {
  barrel: [
    'M6 4.5c-1.3 2-2 4.5-2 7.5s.7 5.5 2 7.5',
    'M18 4.5c1.3 2 2 4.5 2 7.5s-.7 5.5-2 7.5',
    'M6 4.5h12M4.5 8h15M4.5 16h15M6 19.5h12',
  ],
  tank: ['M7 5h10v13H7z', 'M9 3h6v2M9 18v3M15 18v3', 'M10 10h4M12 8v4'],
  demijohn: [
    'M10 3h4v4c0 1.2.8 2 1.8 3 1.4 1.3 2.2 3.1 2.2 5 0 3.3-2.7 5-6 5s-6-1.7-6-5c0-1.9.8-3.7 2.2-5C9.2 9 10 8.2 10 7V3Z',
    'M9.5 6h5',
  ],
  ...
  bubbles: [
    'M8 15a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z',
    'M16.5 10a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z',
    'M16.5 20a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z',
  ],
  ...
  density: [
    'M4 7c2-2 4-2 6 0s4 2 6 0 4-2 4 0',
    'M4 12c2-2 4-2 6 0s4 2 6 0 4-2 4 0',
    'M4 17c2-2 4-2 6 0s4 2 6 0 4-2 4 0',
  ],
  ...
  wine: ['M7 3h10l-1 5c-.5 2.5-1.8 4-4 4s-3.5-1.5-4-4L7 3Z', 'M12 12v7M8 21h8'],
  batch: ['M6 5h12v15H6z', 'M8 3h8v2M9 9h6M9 13h6M9 17h4'],
  info: ['M12 11v6M12 7.5v.1', 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Z'],
  sync: ['M20 7h-5V2', 'M4 17h5v5', 'M18.5 11a7 7 0 0 0-12-4L4 9', 'M5.5 13a7 7 0 0 0 12 4l2.5-2'],
